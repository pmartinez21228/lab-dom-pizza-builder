...
function renderButtons() {
  ...
  let pepperButton= document.querySelector('.btn.btn-green-peppers')
...
function renderPrice() {
  ...
  let pepPrice= document.querySelector('.pepPrice')
  let mushroomPrice= document.querySelector('.mushroomPrice')
  let pepperPrice= document.querySelector('.pepperPrice')
  let saucePrice= document.querySelector('.saucePrice')
  let crustPrice= document.querySelector('.crustPrice')
  if(!state.pepperonni){
